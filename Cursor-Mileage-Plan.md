...
**Deliverable:** every run is traceable; anti-hallucination rules enforced automatically in CI.
**Demo:** intentionally feed a stale/garbage chart → the eval **fails the build**; the trace shows exactly where verification rejected it.
